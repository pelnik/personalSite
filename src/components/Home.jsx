          ...
          <div className="textContentContainer" id="indexTextContentContainer">
            <div className="indexTextContent">
              ...
              <p>
                ...
                an engineering background and have worked in tech, healthcare,
                and energy. Please have a look at my portfolio and about section
                to learn more about me.
              </p>
              <p>
                👉 I have worked previously with Oracle in their healthcare
                group building low code automation systems. I wanted to turn my
                interest into a career and code full time, and I would love to
                talk.
              </p>
            </div>
          </div>
