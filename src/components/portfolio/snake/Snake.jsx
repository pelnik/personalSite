...
function Snake() {
  ...
  useEffect(() => {
    document.title =
      'Classic Snake Game - Matthew Pelnik, Full Stack Web Software Engineer';
  }, []);
          ...
          <div id="full-game-container">
            <div id="game-button-parent">
              <div id="game-header-buttons">
                <button
                  className="start-button-not-started"
                  id="start-button"
                  type="button"
                >
                  Start
            ...
            <div id="game-wall">
              <div id="game-content">{/* JS inserts "pixels" here */}</div>
            </div>
          </div>
        </div>
          ...
          <div id="footerIconParent">
            <a href="https://www.linkedin.com/in/mpelnik/">
              <img
                ...
                src="/Media/snake/linkedin_icon.svg"
                alt="linkedIn icon"
              />
            </a>
            <a href="https://github.com/pelnik">
              <img
                className="footerIcon"
                src="/Media/snake/github_icon.svg"
                alt="gitHub icon"
              />
            </a>
            <a href="tel:9187982238">
              <img
                className="footerIcon"
                src="/Media/snake/phone_icon.svg"
                alt="phone icon"
              />
            </a>
            <a href="mailto:matt@pelnik.dev">
              <img
                className="footerIcon"
                src="/Media/snake/email_icon.svg"
                alt="email icon"
              />
            </a>
          </div>
